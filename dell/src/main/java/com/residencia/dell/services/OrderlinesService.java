...
import com.residencia.dell.exceptions.OrderlinesException;
...
public class OrderlinesService {
    ...
    public void atualizar (Orderlines orderlines, Integer id) throws OrderlinesException{
		//Utilizando o Exception
    if(null == id)
			throw new OrderlinesException("Não foi informado um ID válido.");
